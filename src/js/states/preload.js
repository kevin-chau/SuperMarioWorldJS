export default class Preload extends Phaser.State {
    ...
    preload() {
      ...
      // this.load.atlasJSONArray('pipes', '../../assets/iamges/pipes/pipes.png', '../../assets/iamges/pipes/pipes.json');
      //
      // // Music
      // // this.load.audio('Overworld Theme', '../../assets/sound/music/2-53\ Overworld\ Theme\ (SMW).mp3')
      //
      // // Sound Effects
      // this.load.audio('Jump Wav', '../../assets/sound/effects/jump.wav');
      // this.load.audio('Coin Wav', '../../assets/sound/effects/coin.wav');
      // this.load.audio('Spin Wav', '../../assets/sound/effects/spin.wav');
